...
export const codeSections = [
    {
      id: 'a1',
      title: '(a)(1) Offenses involving actual or perceived race, color, religion, or national origin',
      content: `
  ...
  any person—
    ...
    {
      id: 'a2',
      title: '(a)(2) Offenses involving actual or perceived religion, national origin, gender, sexual orientation...',
      content: `
  ...
  described in this subparagraph are that—
    ...
    (ii) the defendant uses a channel, facility, or instrumentality of interstate
         or foreign commerce in connection with the conduct described in
         subparagraph (A);
    (iii) in connection with the conduct described in subparagraph (A), the
          defendant employs a firearm, dangerous weapon, explosive or incendiary
          device, or other weapon that has traveled in interstate or foreign commerce;
    ...
    {
      id: 'a3',
      title: '(a)(3) Offenses occurring in the special maritime or territorial jurisdiction of the United States',
      content: `
  ...
  (without regard to whether that conduct occurred in a circumstance described
  in paragraph (2)(B)) shall be subject to the same penalties as prescribed in
  those paragraphs.
      `
    },
    {
      id: 'a4',
      title: '(a)(4) Guidelines',
      content: `
  ...
  that shall establish neutral and objective criteria for determining whether a
  crime was committed because of the actual or perceived status of any person.
      `
    },
    {
      id: 'a5',
  ...
  death or serious bodily injury (as defined in section 2246 of this title) results
  from the offense, be imprisoned for not more than 30 years, fined in accordance
  with this title, or both.
      `
    },
    {
      id: 'a6',
      title: '(a)(6) Other conspiracies',
      content: `
  Whoever conspires to commit any offense under paragraph (1), (2), or (3) shall, if
  death or serious bodily injury (as defined in section 2246 of this title) results
  from the offense, or if the offense includes kidnapping or an attempt to kidnap,
  aggravated sexual abuse or an attempt to commit aggravated sexual abuse, or an
  attempt to kill, be imprisoned for not more than 30 years, fined in accordance
  with this title, or both.
      `
    },
    {
      id: 'b',
      title: '(b) Certification Requirement',
      content: `
  ...
  In this section—
    (1) the term “bodily injury” has the meaning given such term in section 1365(h)(4)
        of this title, but does not include solely emotional or psychological harm
        to the victim;
    ...
    {
      id: 'd',
      title: '(d) Statute of Limitations',
      content: `
  (1) Offenses not resulting in death.—Except as provided in paragraph (2), no person
  shall be prosecuted, tried, or punished for any offense under this section unless
  the indictment for such offense is found, or the information for such offense is
  instituted, not later than 7 years after the date on which the offense was committed.
  ...
  limitation.
    ...
    {
      id: 'e',
      title: '(e) Supervised Release',
      content: `
  If a court includes, as a part of a sentence of imprisonment imposed for a violation
  of subsection (a), a requirement that the defendant be placed on a term of supervised
  release after imprisonment under section 3583, the court may order, as an explicit
  condition of supervised release, that the defendant undertake educational classes
  or community service directly related to the community harmed by the defendant’s
  offense.
      `
    },
    {
      ...
      content: `
  (Added and amended Pub. L. 111–84, div. E, §§ 4707(a), 4711, Oct. 28, 2009,
  123 Stat. 2838, 2842; Pub. L. 117–13, § 5(h), May 20, 2021, 135 Stat. 272; Pub. L.
  117–107, § 2, Mar. 29, 2022, 136 Stat. 1125.)
      `
    }
  ];
